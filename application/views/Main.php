...
<body>
	...
	<div class="wrapper">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			...
			<a href="index.html"><img class="brand-img pull-left" src="<?php echo base_url()?>assets/logo.png"
					alt="brand" /></a>
		...
		<div class="page-wrapper pt-0">
			...
			<footer class="footer container-fluid pl-30 pr-30">
				<div class="row">
					<div class="col-sm-5">
						<a href="index.html" class="brand mr-30"><img src="<?php echo base_url()?>assets/logo.png"
								alt="logo" /></a>
